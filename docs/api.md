...
| **read**        | `GET`      | Auth-Key Content-Type | type or category                                                                                   | id SKU type_id type_name type_altname category_id category_name description qty qtyIn qtyOut qty_collections_allocated supplier inventoryDate | \$host\$/rims/api/inventory/read.php        |
